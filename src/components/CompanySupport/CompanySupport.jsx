    ...
    return (
        <div className='support GlobalWrapper'>
            <div className='support-titles'>
                ...
                <h1 className='support-titles__title'>tiklash uchun tizimli yondashuvdan foydalanadi,</h1>
                <h1 className='support-titles__title-bottom'>bu <span>3 bosqichdan</span> iborat:</h1>
            </div>
                ...
                <div className='support-cards__card'>
                    <span className='support-cards__card__number'>
                        <svg width="32" height="74" viewBox="0 0 32 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.3" d="M0.964063 19.3V0.899999H31.7641V74H11.2641V19.3H0.964063Z" fill="#69CB3A" />
                        </svg>
                    </span>
            ...
            <div className='support-bottom-titeles'>
                <p className='support-bottom-titeles__text'>“Mehrigiyo” shifobaxsh mahsulotlari kasalliklarning</p>
                <p className='support-bottom-titeles__text'>oldini oladi hamda uzoq, sog‘lom va to‘kin hayot</p>
                <p className='support-bottom-titeles__text'>manbai bo‘lib xizmat qiladi</p>
